...
class theme_klassplace_format_weeks_renderer extends format_weeks_renderer {
    ...
    protected function section_activity_summary($section, $course, $mods) {
        ...
        if ($total > 0) {
            ...
            $percenttext = get_string('myprogresspercentage', 'theme_klassplace');
    ...
    protected function section_edit_control_items($course, $section, $onsectionpage = false) {
        ...
        if (!empty($this->availablestyles) && ($section->section > 0) && $PAGE->user_is_editing()) {
            if (has_capability('moodle/course:update', $context) || $caneditsection) {
                ...
                $contentclassurl = new moodle_url('/theme/klassplace/sections/sectionclass.php', $params);
