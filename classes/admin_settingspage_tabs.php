 ...
 * @package   theme_klassplace
 * @copyright 2022 Valery Fremaux
s * @license   http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class theme_klassplace_admin_settingspage_tabs extends admin_settingpage {
    ...
    public function output_html() {
        ...
        return $OUTPUT->render_from_template('theme_klassplace/admin_setting_tabs', $context);
    }
