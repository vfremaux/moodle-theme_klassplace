    ...
    var n = function() {
        var n = {
            ...
            c = function() {
                var s = e(this),
                    n = p(s);
                n && clearTimeout(n.sfTimer), s.siblings().superfish("hide").end().superfish("show")
            },
            f = function(s) {
            ...
            d = function() {
                var s = e(this),
                    n = p(s);
                t ? e.proxy(f, s, n)() : n && (clearTimeout(n.sfTimer), n.sfTimer = setTimeout(e.proxy(f, s, n), n.delay))
            },
            v = function(s) {
                var n = e(this),
                    t = p(n),
                    o = n.siblings(s.data.popUpSelector);
                return t && t.onHandleTouch.call(o) === !1 ? this : void((o.length > 0 && o.is(":hidden") && (n.one("click.superfish", !1), "MSPointerDown" === s.type || "pointerdown" === s.type ? n.trigger("focus") : e.proxy(c, n.parent("li"))())))
            },
            m = function(s, n) {
        ...
        return {
            ...
            destroy: function() {
                return this.each(function() {
                    var s, t = e(this),
                        o = t.data("sfOptions");
                    return o ? (s = t.find(o.popUpSelector).parent("li"), clearTimeout(o.sfTimer), r(t, o), l(s), h(t), t.off(".superfish").off(".hoverIntent"), s.children(o.popUpSelector).attr("style", function(e, s) {
